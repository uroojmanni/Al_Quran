...
public class Adapter_Dua extends RecyclerView.Adapter <Adapter_Dua.ViewHolder> {

    Context context;

    List<Model_surah> list;

    public Adapter_Dua(Context context, List<Model_surah> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Adapter_Dua.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(context, Dua_data_Activity.class);
