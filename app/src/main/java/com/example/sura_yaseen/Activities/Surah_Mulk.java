...
public class Surah_Mulk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_surah_mulk);

        recyclerView= findViewById(R.id.mulk_recycle2);
        ...
        list1= Quran_data_repository.mulk_data();
        //get data
